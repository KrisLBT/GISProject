...
The reason why we want to analyze Catchment Population Distribution (Walking) this way because we want to explore how effective are the walking catchment areas of the upcoming Thomson East Coast Line Stage 4 MRT Stations are based on current road network present. 

Additionally, with the current road network present, it is [important to analyze the proportion of Singaporeans who is wiling to walk at each contour distance](https://www.researchgate.net/publication/245561443_Using_Equivalent_Walking_Distance_to_Assess_Pedestrian_Accessibility_to_Transit_Stations_in_Singapore) to evaluate the location chosen for the TEL Stage 4 MRT Stations.
...
+-------------------------------------+-----------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------+
| Percentage Population               | Calculated Percentage of Subzone Population who is willing to walk to MRT Station | Total Population (Willing to Walk to MRT) within Contour / Total Subzone Population \* 100 |
+-------------------------------------+-----------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------+
...
Furthermore, we will explore how effective are the catchment areas of the upcoming Thomson East Coast Line Stage 4 MRT Station based on current road network present in encouraging Singaporeans to cycle. 
...
The reason why we want to analyze Catchment Population Distribution (Cycling) this way because we want to explore how effective are the cycling catchment areas of the upcoming Thomson East Coast Line Stage 4 MRT Stations are based on current road network present. 

However, based on URA,[it is stated that only 3.9% of Singaporeans take a combination of transportation.](https://www.singstat.gov.sg/-/media/files/visualising_data/infographics/c2020/c2020-geographical-distribution-transport.ashx) For example, one combination would be cycling and taking the bus. Therefore, the proportion of Singapore who cycles and takes the MRT is far lesser than the 3.9% stated. As a result, due to the low numbers, a better analysis would be how accessible TEL Stage 4 MRT Stations would be from the various subzones that fall within 1.6km radius instead of the number of people who is willing to cycle within the catchment area. 

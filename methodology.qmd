...
Notice that QNEAT3 appears on the search
output list.
...
When the installation is completed, close
the dialog box by
...
Note: Replace the version number x
according to your installation) into the terminal,

-   Press **Enter** and confirm installation with *yes* when prompted

-   Restart QGIS3

After this installation, you are ready to
use all QNEAT3 Algorithms.
...
 [\[XX1\]](#_msoanchor_1)Need to show how to import and save as geopackage

 [\[XX2\]](#_msoanchor_2)Additionally, need to show how to extract out the MRT Exits
